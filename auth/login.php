  ...
  <main class="login-page">
    <div class="login-box fade-in">
      ...
      <div class="login-body">
        ...
        <form action="<?= BASE_URL ?>/auth/process_login.php" method="POST" id="loginForm" data-validate-form
          novalidate>
  ...
  <script>
    ...
    if (loginForm) {
      loginForm.addEventListener('submit', function (e) {
        // Form validation passes first (if you have custom validate script)
        e.preventDefault();

        // Check required fields manually since we intercepted submit
