...
// Cần phải có pending_user mới được vào trang này
...
// Ẩn bớt email (ví dụ: ng**********@gmail.com)
  ...
  <main class="login-page">
    <div class="login-box fade-in">
      ...
      <div class="login-body">
        ...
        <form action="<?= BASE_URL ?>/auth/process_otp.php" method="POST" id="otpForm" data-validate-form novalidate>
          ...
          <div style="text-align: center; margin-top: 15px;">
            <a href="<?= BASE_URL ?>/auth/login.php" style="font-size:14px;color:var(--text-muted);"><i
          ...
          if (data.success) {
            ...
            Swal.fire({
              ...
              confirmButtonColor: '#28a745'
                ...
                if (data.session_out) {
                    window.location.href = '<?= BASE_URL ?>/auth/login.php?error=session_out';
                }
            });
