 ...
 */
?>
  <footer style="background:#1a1a2e;color:#ecf0f1;padding:20px;text-align:center;margin-top:40px;border-top:3px solid var(--primary)">
    <div style="max-width:1400px;margin:0 auto">
      ...
      <p style="margin:8px 0 0;font-size:12px;color:#aaa">
        © <?= date('Y') ?> QNU Student Management System. Hỗ trợ: admin@qnu.edu.vn
      </p>
    </div>
  </footer>
  <script>
