<?php
/**
 * student/ca_nhan/thong_tin.php - UC1: Xem thông tin cá nhân
 */
define('ROOT', __DIR__ . '/../..');
  ...
  <div class="student-container">
    ...
    <div class="profile-header fade-in">
      ...
      <div style="margin-left:auto">
        <a href="<?= BASE_URL ?>/student/ca_nhan/cap_nhat.php" class="btn btn-primary">
      ...
      <div>
        ...
        <div class="card mt-12 fade-in">
          <div class="card-body" style="display:flex;flex-direction:column;gap:8px;padding:16px">
            <a href="<?= BASE_URL ?>/student/ca_nhan/tien_do.php" class="btn btn-outline w-100">
              <i class="fas fa-tasks"></i> Xem tiến độ tín chỉ
            </a>
            <a href="<?= BASE_URL ?>/student/hoc_tap/diem_hoc_tap.php" class="btn btn-outline w-100">
