...
<div class="student-wrapper">
  <div class="student-container" style="max-width:900px">
    ...
    <?php if (empty($trainingPointsInfo['drl_list'])): ?>
    ...
    <div class="stat-grid fade-in">
      <div class="stat-card">
        ...
        <div>
          <div class="stat-value" style="color:<?= rlColor((int)$trainingPointsInfo['avg_drl']) ?>"><?= $trainingPointsInfo['avg_drl'] ?></div>
      ...
      <div class="stat-card">
        ...
        <div>
          <div class="stat-value"><?= max(array_column($trainingPointsInfo['drl_list'],'diem')) ?></div>
      ...
      <div class="stat-card">
        ...
        <div>
          <div class="stat-value"><?= min(array_column($trainingPointsInfo['drl_list'],'diem')) ?></div>
      ...
      <div class="stat-card">
        ...
        <div>
          <div class="stat-value"><?= count($trainingPointsInfo['drl_list']) ?></div>
    ...
    <div class="card mb-20 fade-in">
      ...
      <div class="card-body">
        <div style="display:flex;align-items:flex-end;gap:16px;height:160px;padding:0 10px">
          <?php foreach ($trainingPointsInfo['drl_list'] as $drl): ?>
      ...
      <table>
        ...
        <tfoot>
          <tr style="background:#f0f4ff;font-weight:700">
            ...
            <td style="border:1px solid var(--border);text-align:center;font-size:20px;color:<?= rlColor((int)$trainingPointsInfo['avg_drl']) ?>"><?= $trainingPointsInfo['avg_drl'] ?></td>
